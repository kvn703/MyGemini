...
Welcome to **MyGemini**, a comprehensive clone of the Google Gemini interface, available on both **Web** and **Mobile** platforms. This project demonstrates the integration of Google's AI models into frontend architectures.
